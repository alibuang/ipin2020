...
class mywindow(QMainWindow):
    ...
    def test_arbitrage(self):
        ...
        try:
            ...
            # print("{} Master price ask:{} bid:{} spread:{}".format(self.broker_master.symbols,
            #                                                        self.broker_master.ask,
            #                                                        self.broker_master.bid,
            #                                                        self.broker_master.spread))
            # print("{} Slave  price ask:{} bid:{} spread:{}".format(self.broker_slave.symbols,
    ...
    def opennew_arbitposition(self, master, slave):
        ...
        for i in range(len(self.cfg.symbols)):
            ...
            # print ('{} : gap up is {} and gap down is {}'.format(self.cfg.symbols[i],
            #                                                      self.gap_up[i],
            #                                                      self.gap_down[i]))
            ...
            # print("check for open valid : {}".format(self.chk_open_valid(slave, slave.symbols[i])))
